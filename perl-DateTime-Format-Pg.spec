...
Requires: perl-DateTime-Format-Pg-man
...
%package man
Summary: man components for the perl-DateTime-Format-Pg package.
Group: Default

%description man
man components for the perl-DateTime-Format-Pg package.
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/DateTime/Format/Pg.pm
